...
<body>
      <div class="logina-logo" style="height: 109px">
        <a href="">
            <img src="/res/toplogo.png" height="60" alt="java sso">
        </a>
    </div>
                        ...
                        <tr id="tr-vcode">
                            ...
                            <td width="245">
                                <div class="valid">
                                    ...
                                    <img onclick="this.src=('/verify?reload='+(new Date()).getTime())" class="vcode" src="/verify" width="85" height="35" alt="">
                                </div>
                            </td>
                            <td>
                            </td>
